...
class imgUpldr {
    ...
    private $_width = 2000; // Ancho máximo por defecto
    private $_height = 2000; // Alto máximo por defecto
    ...
    public function init($img, $destinoCarpeta) {
        $this->_img = $img;
        $this->_dest = $destinoCarpeta;
